...
import pubmed.sql.TitleLemmaTable;

import org.junit.*;
import static org.junit.Assert.*;

public class TitleLemmaTableTest {
    ...
    @Test public void testInsertAdd() {
        TitleLemmaTable.dropTable();
        TitleLemmaTable table = TitleLemmaTable.instance();
        ...
        assertEquals(10, table.fetchKey1(pmid1).size());
        assertEquals( 8, table.fetchKey1(pmid2).size());
        assertEquals(12, table.fetchKey1(pmid3).size());
        ...
        assertEquals( 8, table.fetchKey1(pmid2).size());
        assertEquals(12, table.fetchKey1(pmid3).size());
        assertEquals( 7, table.fetchKey1(pmid4).size());
        assertEquals( 0, table.fetchKey1(pmid5).size());
    }

    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main("pubmed.junit.TitleLemmaTableTest");
    }
}
