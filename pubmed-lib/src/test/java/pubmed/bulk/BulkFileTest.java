...
public class BulkFileTest {
    ...
    @Test public void testCanonicalPrefix() {
        assertEquals(JamEnv.getRequired("PUBMED_LIB_HOME") + "/data/test/pubmed20n0001", bulk0001.getCanonicalPrefix());
    }

    @Test public void testList() {
        assertEquals(List.of(bulk0001, bulk0002, bulk1203), List.of(BulkFile.list(testDir)));
    }
    ...
    */
    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main("pubmed.bulk.BulkFileTest");
    }
}
