...
public class MeshDescriptorTest {
    ...
    @Test public void testRegistry() {
        assertEquals(descriptors.get(0), MeshDescriptor.instance(key1));
        assertEquals(descriptors.get(1), MeshDescriptor.instance(key2));
        assertEquals(descriptors.get(2), MeshDescriptor.instance(key3));
    }
    ...
    public static void main(String[] args) {
        org.junit.runner.JUnitCore.main("pubmed.mesh.MeshDescriptorTest");
    }
}
